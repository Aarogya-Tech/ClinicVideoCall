...
import com.aarogyaforworkers.aarogyaFDC.SubUser.isItFromHistoryPage
    ...
    if (showDialog) {
        if (!sendingMessage && !messageSent && !showFailedDialog) {
            ...
            AlertDialog(
                ...
                text = { Text("The message has been sent to ${user.first_name} on WhatsApp.") },
                confirmButton = {
                    Button(
                        onClick = {
                            showDialog = false }
            ...
            AlertDialog(
                ...
                text = { Text("Failed to send message to ${user.first_name} on WhatsApp.") },
                confirmButton = {
                    Button(
                        onClick = {
                            sendingMessage = true
